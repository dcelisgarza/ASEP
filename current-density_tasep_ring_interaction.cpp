...
//======================== for periodic boundary conditions (ring). Current vs. rho =========================//
//===========================================================================================================//
...
int main()
{
	...
	if (strcmp (key,buffer) != 0)
	{
		fileNameStreamS << tc << "_S_Jrho" << "[" << rho_min << "," << rho_max << "]" <<"_E="<< epsilon << "_th=" << theta <<".txt";
	}
	if (strcmp (key,buffer) == 0)
	{
		fileNameStreamS << tc << "_S_Jrho" << "[" << rho_min << "," << rho_max << "]" <<"_E="<< epsilon <<".txt";
	}
	...
	if (strcmp (key,buffer) != 0)
	{
		fileNameStreamT << tc << "_T_Jrho" << "[" << rho_min << "," << rho_max << "]" <<"_E="<< epsilon << "_th=" << theta <<".txt";
	}
	if (strcmp (key,buffer) == 0)
	{
		fileNameStreamT << tc << "_T_Jrho" << "[" << rho_min << "," << rho_max << "]" <<"_E="<< epsilon <<".txt";
	}
	...
	if (strcmp (key,buffer) != 0)
	{
		fileNameStreamL << tc << "_L_Jrho" << "[" << rho_min << "," << rho_max << "]" <<"_E="<< epsilon << "_th=" << theta <<".txt";
	}
	if (strcmp (key,buffer) == 0)
	{
		fileNameStreamL << tc << "_L_Jrho" << "[" << rho_min << "," << rho_max << "]" <<"_E="<< epsilon <<".txt";
	}
	...
	q3<< " T = " << T << endl;
	q3<< " dt = " << dt <<endl;
	q3<< " rho_min = " << rho_min << endl;
	q3<< " rho_max = " << rho_max << endl;
	q3<< " drho = " << drho << endl;
	q3<< " E = " << epsilon << endl;
	if (strcmp (key,buffer) != 0)
	{
